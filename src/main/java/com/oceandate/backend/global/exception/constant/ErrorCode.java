...
public enum ErrorCode {
    ...
    NOT_SUPPORTED_INSTALLMENT_PLAN_MERCHANT("TOSS_010", "할부 미지원 가맹점입니다"),
    ...
    INVALID_ACCOUNT_INFO_RE_REGISTER("TOSS_014", "계좌 정보 재등록이 필요합니다"),
    NOT_AVAILABLE_PAYMENT("TOSS_015", "결제가 불가능한 시간대입니다"),
    UNAPPROVED_ORDER_ID("TOSS_016", "승인되지 않은 주문입니다"),
    REJECT_CARD_PAYMENT("TOSS_017", "카드사에서 승인이 거절되었습니다"),
    REJECT_CARD_COMPANY("TOSS_018", "카드사에서 거부되었습니다"),
    FORBIDDEN_REQUEST("TOSS_019", "허용되지 않은 요청입니다"),
    REJECT_TOSSPAY_INVALID_ACCOUNT("TOSS_020", "유효하지 않은 토스페이 계좌입니다"),
    EXCEED_MAX_WEEKLY_PAYMENT_COUNT("TOSS_021", "주간 결제 횟수를 초과했습니다"),
    EXCEED_MAX_WEEKLY_PAYMENT_AMOUNT("TOSS_022", "주간 결제 금액을 초과했습니다"),
    EXCEED_MAX_MONTHLY_PAYMENT_COUNT("TOSS_023", "월간 결제 횟수를 초과했습니다"),
    NOT_FOUND_PAYMENT_SESSION("TOSS_024", "결제 세션을 찾을 수 없습니다"),
