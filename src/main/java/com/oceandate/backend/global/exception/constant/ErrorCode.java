...
public enum ErrorCode {
    ...
    PAYMENT_NOT_FOUND("PAYMENT_404", "결제 정보를 찾을 수 없습니다."),
    ORDER_NOT_FOUND("ORDER_404", "주문을 찾을 수 없습니다."),
    INVALID_PAYMENT_STATUS("PAYMENT_400", "결제 가능한 상태가 아닙니다."),
    INVALID_CANCEL_STATUS("PAYMENT_400", "취소 가능한 상태가 아닙니다."),
    ...
    //취소
    CANCEL_REQUEST_ALREADY_EXISTS("CANCEL_400", "이미 취소 요청된 신청입니다."),
    CANCEL_REQUEST_NOT_FOUND("CANCEL_404", "취소 신청을 찾을 수 없습니다."),
    CANCEL_REQUEST_ALREADY_PROCESSED("CANCEL_400", "이미 취소된 신청입니다."),

    //포트원
    ALREADY_PROCESSED_PAYMENT("PORTONE_001", "이미 처리된 결제입니다"),
    PROVIDER_ERROR("PORTONE_002", "일시적인 오류가 발생했습니다. 잠시 후 다시 시도해주세요"),
    EXCEED_MAX_DAILY_PAYMENT_COUNT("PORTONE_003", "하루 결제 가능 횟수를 초과했습니다"),
    NOT_AVAILABLE_BANK("PORTONE_004", "은행 서비스 시간이 아닙니다"),
    EXCEED_MAX_AMOUNT("PORTONE_005", "결제 가능 금액을 초과했습니다"),
    INVALID_CARD_EXPIRATION("PORTONE_006", "카드 유효기간이 만료되었습니다"),
    INVALID_STOPPED_CARD("PORTONE_007", "정지된 카드입니다"),
    EXCEED_MAX_CARD_MONTHLY_AMOUNT("PORTONE_008", "월 한도를 초과했습니다"),
    INVALID_CARD_INSTALLMENT_PLAN("PORTONE_009", "할부가 불가능한 카드입니다"),
    INVALID_AUTHORIZE_AUTH("PORTONE_010", "카드 정보가 정확하지 않습니다"),
    INVALID_CARD_LOST_OR_STOLEN("PORTONE_011", "분실 또는 도난 카드입니다"),
    RESTRICTED_TRANSFER_ACCOUNT("PORTONE_012", "계좌가 정지 상태입니다"),
    NOT_AVAILABLE_PAYMENT("PORTONE_013", "결제가 불가능한 시간대입니다"),
    REJECT_CARD_PAYMENT("PORTONE_014", "카드사에서 승인이 거절되었습니다"),
    FORBIDDEN_REQUEST("PORTONE_015", "허용되지 않은 요청입니다"),
    PAYMENT_SESSION_EXPIRED("PORTONE_016", "결제 시간이 만료되었습니다"),
    NOT_FOUND_PAYMENT("PORTONE_017", "결제 정보를 찾을 수 없습니다"),
    FAILED_INTERNAL_SYSTEM_PROCESSING("PORTONE_018", "결제가 완료되지 않았습니다. 다시 시도해주세요"),
    UNKNOWN_PAYMENT_ERROR("PORTONE_019", "알 수 없는 결제 오류가 발생했습니다"),
